...
def process_ego_and_lane_data(ego_file, skip_rows, look_back, look_ahead):
    ...
    for i in range(look_back, len(ego_data) - look_ahead, skip_rows):
        ...
        if i - look_back >= 0:
            ...
            offsets = np.array([[ego_data.iloc[i, 1], ego_data.iloc[i, 2], 0, 0, 0, 0, 0] for j in range(i-look_back+1, i+1)])
...
# 결과를 CSV 파일로 저장
final_dataset.to_csv('/home/taewook/catkin_ws/src/beginner_tutorials/data/processed_data/dataset_lane_global.csv', index=False, header=False)
print("Saving sucess")
...
# raw 데이터 저장
output_file_path = '/home/taewook/catkin_ws/src/beginner_tutorials/data/ego_tracking_data_raw_combine_lane_global.csv'
