            ...
            if current_time - self.last_update_time >= 0.1:
                ...
                if hasattr(self, 'data_buffer') :  # Check if data_buffer is defined and not empty
                    ...
                    input_data = [self.ego_vehicle.position[0], self.ego_vehicle.position[1],
                                  ...
                                  self.ego_vehicle.yaw,self.lane_data[0] - self.ego_vehicle.position[0], self.lane_data[1] - self.ego_vehicle.position[0], self.lane_data[2] - self.ego_vehicle.position[0]
                                ]
                    ## Ego에서 추가된 부분
